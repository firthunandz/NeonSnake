import snakelogo from '../assets/images/neonsnakelogo.jpg'
...
export const Header = () => {
  ...
  return (
    <>
      <header className='w-full flex flex-row justify-around items-center mb-12'>
        <img src={snakelogo} alt="Neon Snake app logo" />
        <h1 className='text-fandango text-4xl font-extrabold'>Neon Snake</h1>
        <section className='flex flex-col items-center justify-center gap-1'>
          <p className='text-zaffre font-bold'>Firthunandz</p>
          <p className='text-zaffre'>28/6/2024</p>
          <div className='flex flex-row gap-2'>
            <a target="_blank" href="https://www.linkedin.com/in/fernando-chiesa-258ab925a/">
            ...
            <a target="_blank" href="https://github.com/firthunandz">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 64 64">
